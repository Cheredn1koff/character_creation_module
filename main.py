...
def choice_char_class() -> str:
    ...
    while approve_choice != 'y':
        ...
        input('хочешь играть: Воитель — warrior,')
        input('Маг — mage, Лекарь — healer: ')
        if char_class == 'warrior':
        ...
        approve_choice: None = input('Нажми (Y), чтобы подтвердить выбор,')
        input('или любую другую кнопку,')
        input('чтобы выбрать другого персонажа ').lower()
    return char_class
